...
while INTENTOS < 5:
	...
	if SALIDA == 1:
		INTENTOS += 1
		TURNO2 -= 1
		if INGRESO < ALEATORIO and INGRESO > 0:
			print u"Incorrecto. El número es Mayor. Inténtalo de nuevo."# verifica si el numero es muy alto
			SALIDA = 0
			TURNO2 = str(TURNO2)
			print u"Te quedan "+ TURNO2 +" intentos\n"
			TURNO2 = int(TURNO2)
		if INGRESO > ALEATORIO and INGRESO < 20:
			print u"Incorrecto. El numero es Menor. Inténtalo de nuevo." #verifica si el numero es muy bajo
			SALIDA = 0
			TURNO2 = str(TURNO2)
			print u"Te quedan "+ TURNO2 +" intentos\n"
			TURNO2 = int(TURNO2)
...
if INGRESO == ALEATORIO:
	...
	print u"¡Correcto!, " + JUGADOR + u" Usted gano adivino el número en, " + INTENTOS +u" intentos\n"
...
if INTENTOS == 5:
	...
	print u"Juego incorrecto otra vez.\nEl número correcto era: " + ALEATORIO +"\n"
	print u"                     **** Adivinador Full Pro 2.0 © **** "
	print u"                            ***** Cognits *****"
	print u"                         Third Generation Grupo # 2 :\n "
	print u"                               Annabel Girón"
